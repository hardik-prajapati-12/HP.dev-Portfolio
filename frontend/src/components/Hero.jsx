          ...
          <div className="hero-right" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative', width: '100%', height: '100%' }}>
            ...
            >
              <svg width="100%" height="100%" viewBox="0 0 800 600" fill="none" style={{ position: 'absolute', inset: 0 }}>
                ...
                {/* --- Background Static Blue/Cyan Traces (Layer 1) --- */}
                <g stroke={isDark ? "rgba(30, 64, 175, 0.15)" : "rgba(6, 182, 212, 0.22)"} strokeWidth="1.2" fill="none">
                  ...
                  {/* Background Parallel Diagonals (Top Right area) */}
                ...
                <g>
                  {/* Left-side Nodes */}
                  <g>
                    <circle cx="80" cy="420" r="5" fill="#00d8ff" opacity="0.4" filter="url(#cyanGlow)" />
                    <circle cx="80" cy="420" r="2.5" fill="#ffffff" />
                  </g>
                  <g>
                    <circle cx="100" cy="350" r="5" fill="#00d8ff" opacity="0.4" filter="url(#cyanGlow)" />
                    <circle cx="100" cy="350" r="2.5" fill="#ffffff" />
                  </g>
                  <g>
                    <circle cx="130" cy="310" r="5" fill="#00d8ff" opacity="0.4" filter="url(#cyanGlow)" />
                    <circle cx="130" cy="310" r="2.5" fill="#ffffff" />
                  </g>
                  <g>
                    <circle cx="150" cy="140" r="5" fill="#00d8ff" opacity="0.4" filter="url(#cyanGlow)" />
                    <circle cx="150" cy="140" r="2.5" fill="#ffffff" />
                  </g>

                  {/* Mid/Junction Nodes */}
                  <g>
                    <circle cx="350" cy="350" r="5" fill="#00d8ff" opacity="0.4" filter="url(#cyanGlow)" />
                    <circle cx="350" cy="350" r="2.5" fill="#ffffff" />
                  </g>
                  <g>
                    <circle cx="410" cy="290" r="5" fill="#00d8ff" opacity="0.4" filter="url(#cyanGlow)" />
                    <circle cx="410" cy="290" r="2.5" fill="#ffffff" />
                  </g>
                  <g>
                    <circle cx="380" cy="460" r="5" fill="#00d8ff" opacity="0.4" filter="url(#cyanGlow)" />
                    <circle cx="380" cy="460" r="2.5" fill="#ffffff" />
                  </g>

                  {/* Right-side Terminus Nodes */}
                  <g>
                    <circle cx="650" cy="290" r="6" fill="#0055ff" opacity="0.5" filter="url(#blueGlow)"
                      style={{ animation: 'node-pulse-hit 3.2s linear infinite', animationDelay: '0.2s' }} />
                    <circle cx="650" cy="290" r="2.5" fill="#ffffff"
                      style={{ animation: 'node-pulse-hit 3.2s linear infinite', animationDelay: '0.2s' }} />
                  </g>
                  <g>
                    <circle cx="620" cy="250" r="6" fill="#0055ff" opacity="0.5" filter="url(#blueGlow)"
                      style={{ animation: 'node-pulse-hit 2.5s linear infinite', animationDelay: '0.8s' }} />
                    <circle cx="620" cy="250" r="2.5" fill="#ffffff"
                      style={{ animation: 'node-pulse-hit 2.5s linear infinite', animationDelay: '0.8s' }} />
                  </g>
                  <g>
                    <circle cx="590" cy="210" r="6" fill="#0055ff" opacity="0.5" filter="url(#blueGlow)"
                      style={{ animation: 'node-pulse-hit 3.8s linear infinite', animationDelay: '1.5s' }} />
                    <circle cx="590" cy="210" r="2.5" fill="#ffffff"
                      style={{ animation: 'node-pulse-hit 3.8s linear infinite', animationDelay: '1.5s' }} />
                  </g>
                  <g>
                    <circle cx="700" cy="480" r="6" fill="#0055ff" opacity="0.5" filter="url(#blueGlow)"
                      style={{ animation: 'node-pulse-hit 3.5s linear infinite' }} />
                    <circle cx="700" cy="480" r="2.5" fill="#ffffff"
                      style={{ animation: 'node-pulse-hit 3.5s linear infinite' }} />
                  </g>
                  <g>
                    <circle cx="730" cy="440" r="6" fill="#0055ff" opacity="0.5" filter="url(#blueGlow)"
                      style={{ animation: 'node-pulse-hit 4s linear infinite', animationDelay: '1.2s' }} />
                    <circle cx="730" cy="440" r="2.5" fill="#ffffff"
                      style={{ animation: 'node-pulse-hit 4s linear infinite', animationDelay: '1.2s' }} />
                  </g>
                  <g>
                    <circle cx="670" cy="520" r="6" fill="#0055ff" opacity="0.5" filter="url(#blueGlow)"
                      style={{ animation: 'node-pulse-hit 2.8s linear infinite', animationDelay: '0.5s' }} />
                    <circle cx="670" cy="520" r="2.5" fill="#ffffff"
                      style={{ animation: 'node-pulse-hit 2.8s linear infinite', animationDelay: '0.5s' }} />
                  </g>
                  <g>
                    <circle cx="600" cy="80" r="6" fill="#0055ff" opacity="0.5" filter="url(#blueGlow)"
                      style={{ animation: 'node-pulse-hit 3s linear infinite', animationDelay: '0.4s' }} />
                    <circle cx="600" cy="80" r="2.5" fill="#ffffff"
                      style={{ animation: 'node-pulse-hit 3s linear infinite', animationDelay: '0.4s' }} />
                  </g>
                  <g>
                    <circle cx="540" cy="160" r="6" fill="#0055ff" opacity="0.5" filter="url(#blueGlow)"
                  ...
                  <g>
                    <circle cx="720" cy="200" r="5" fill="#00d8ff" opacity="0.4" filter="url(#cyanGlow)" />
                    <circle cx="720" cy="200" r="2.5" fill="#ffffff" />
                  </g>
                  <g>
                    <circle cx="690" cy="220" r="5" fill="#00d8ff" opacity="0.4" filter="url(#cyanGlow)" />
                    <circle cx="690" cy="220" r="2.5" fill="#ffffff" />
                  </g>
                  <g>
                    <circle cx="660" cy="240" r="5" fill="#00d8ff" opacity="0.4" filter="url(#cyanGlow)" />
                    <circle cx="660" cy="240" r="2.5" fill="#ffffff" />
                  </g>

                  {/* New Right-to-Bottom Terminus Nodes */}
                  <g>
                    <circle cx="620" cy="560" r="6" fill="#0055ff" opacity="0.5" filter="url(#blueGlow)"
                      style={{ animation: 'node-pulse-hit 3.5s linear infinite' }} />
                    <circle cx="620" cy="560" r="2.5" fill="#ffffff" />
                  </g>
                  <g>
                    <circle cx="600" cy="540" r="6" fill="#0055ff" opacity="0.5" filter="url(#blueGlow)"
                      style={{ animation: 'node-pulse-hit 2.8s linear infinite', animationDelay: '0.5s' }} />
                    <circle cx="600" cy="540" r="2.5" fill="#ffffff" />
                  </g>
                  <g>
                    <circle cx="580" cy="520" r="6" fill="#0055ff" opacity="0.5" filter="url(#blueGlow)"
